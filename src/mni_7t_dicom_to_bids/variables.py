...
bids_dicom_mappings: dict[str, dict[str, list[str] | str]] = {
    'anat': { 
         # FLAIR
        'FLAIR': ['anat-flair_acq-0p7iso_UPAdia','anat-flair_acq-0p7mm_UPAdia','anat-flair_acq-07iso_dev3_5SD_UP'],
        ...
        # 0.7mm MP2RAGE
        'inv-1_MP2RAGE': ['anat-T1w_acq-mp2rage_0.7mm_CSptx_INV1','*anat-T1w_acq-mp2rage_07mm_CSptx_INV1'],
        'inv-2_MP2RAGE': ['anat-T1w_acq-mp2rage_0.7mm_CSptx_INV2','*anat-T1w_acq-mp2rage_07mm_CSptx_INV2'],

        # 0.5mm MP2RAGE
        'acq-05mm_inv-1_MP2RAGE': ['anat-T1w_acq-mp2rage_05mm_UP_INV1','anat-T1w_acq-mp2rage_05mm_UP_INV1_Motion','*anat-T1w_acq-mp2rage_05mm_UP*_INV1'],
        'acq-05mm_inv-2_MP2RAGE': ['anat-T1w_acq-mp2rage_05mm_UP_INV2','anat-T1w_acq-mp2rage_05mm_UP_INV2_Motion','*anat-T1w_acq-mp2rage_05mm_UP*_INV2'],
        'acq-05mm_T1map': ['*anat-T1w_acq-mp2rage_05mm_UP*_T1_Images','anat-T1w_acq-mp2rage_05mm_UP_T1_Images_Motion'],
        'acq-05mm_UNIT1': ['*anat-T1w_acq-mp2rage_05mm_UP*_UNI_Images','anat-T1w_acq-mp2rage_05mm_UP_UNI_Images_Motion'],
        ...
        # NEUROMELANIN
        'acq-neuromelaninMTw_T1w': ['anat-nm_acq-MTboost_sag_0.55mm','CR_tfl_MTboost_sag7deg_0.55mm'],
    ...
    'dwi': {
        ...
        'acq-b0_dir-PA_sbref' : ['dwi_acq_b0_PA_SBRef',
                                 'dwi_acq_b0_PA_acc9_SBRef','*dwi_acq_b0*_PA_SBRef'],
        'acq-b0_dir-PA_dwi'   : ['dwi_acq_b0_PA',
                                 'dwi_acq_b0_PA_acc9','*dwi_acq_b0*_PA'],
        'acq-b01p5_dir-PA_sbref': '*dwi_acq_b0_PA_1p5iso_SBRef',
        'acq-b01p5_dir-PA_dwi': '*dwi_acq_b0_PA_1p5iso',
        
        # SBREF
        'acq-multib38_dir-AP_sbref': ['dwi_acq_multib_38dir_AP_acc9_SBRef','*dwi_acq_multib_38dir_AP_acc9_SBRef'],
        ...
        'acq-multib70_dir-AP_sbref': ['dwi_acq_multib_70dir_AP_acc9_SBRef','*dwi_acq_multib_70dir_AP_acc9_SBRef'],
        ...
        # DWI
        'acq-multib38_dir-AP_dwi': ['dwi_acq_multib_38dir_AP_acc9','*dwi_acq_multib_38dir_AP_acc9'],
        ...
        'acq-multib70_dir-AP_dwi': ['dwi_acq_multib_70dir_AP_acc9','*dwi_acq_multib_70dir_AP_acc9'],
    ...
    'func': {
        ...
        'task-rest_bold': [
            ...
            'func-rsfmri_acq-mbep2d_ME_19mm','*func-rsfmri_acq-mbep2d_ME_19mm'],
